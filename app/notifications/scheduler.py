...
class NotificationScheduler:
    ...
    async def _generate_for_user(
        ...
        generated = await self.generator.generate(prompt, system_prompt, theme, prompt_hash)
...
async def process_event_notification(
    ...
    generated = await generator.generate(prompt, system_prompt, theme, prompt_hash)
